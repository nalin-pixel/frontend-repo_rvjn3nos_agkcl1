...
function Toggle({ checked, onChange }) {
  return (
    <button
      ...
      className={"w-10 h-6 rounded-full p-0.5 transition-colors " + (checked ? 'bg-emerald-500' : 'bg-slate-300')}
    >
    ...
    <SectionWrapper>
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          <input className="h-8 w-full rounded-lg border border-slate-300 bg-white px-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900/20" placeholder="Enter barcode" />
          <button className="h-8 px-3 rounded-lg bg-slate-900 text-white text-sm hover:bg-black w-fit">Submit</button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-slate-50 rounded-lg p-4 border border-slate-200 space-y-3 h-fit">
            ...
            <div className="flex items-center justify-between gap-3"><label className="text-slate-600">Discount</label><input type="number" className="w-40 px-3 py-2 rounded border border-slate-300 bg-white" placeholder="0" /></div>
            <div className="flex items-center justify-between gap-3"><label className="text-slate-600">Tax</label><input type="number" className="w-40 px-3 py-2 rounded border border-slate-300 bg-white" placeholder="0" /></div>
            ...
            <div className="flex items-center justify-between gap-3"><label className="text-slate-600">Payment Amount</label><input type="number" className="w-40 px-3 py-2 rounded border border-slate-300 bg-white" placeholder="0" /></div>
